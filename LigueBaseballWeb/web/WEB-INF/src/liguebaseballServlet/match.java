...
public class match extends HttpServlet
{
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        else if (request.getParameter("byDate") != null)
        {
            traiterByDate(request, response);
        }
    ...
    public void traiterByEquipe(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        try {
         ...
         String EquipeS = request.getParameter("equipe");
         request.getSession().setAttribute("equipe", EquipeS);
         RequestDispatcher dispatcher = request
         .getRequestDispatcher("/WEB-INF/match.jsp");
         dispatcher.forward(request, response);
         } /*catch (Exception e) {
         List listeMessageErreur = new LinkedList();
         listeMessageErreur.add(e.toString());
    ...
    public void traiterByDate(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
         try {
         if (request.getParameter("date") == null)
               throw new Exception("Aucune date");
